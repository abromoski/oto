...
class Directpost extends \Magento\Payment\Model\Method\Cc
{
    ...
    public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        try {
            if ($payment->getParentTransactionId()) {
                ...
                if ($result['response'] == self::NMI_DECLINED) {
                    /* $errorMessage = "Your bank have been cautious and declined the transaction. Please could you contact them to authorise the transaction";  */
                   
                    $errorMessage = $result['responsetext'];
                    if ($this->getResponseText($result['response_code'])!="") {
                        $errorMessage = $this->getResponseText($result['response_code']);
                    }
    ...
    public function getResponseText($response_code="")
    {
        $responseText="";
        switch ($response_code) {
            case 200:
                $responseText = "Unfortunately your transaction was declined by your card issuer. You may need to call the card issuer to authorise your tranaction or try a different card.";
                break;
            case 201:
            ...
            case 202:
                ...
                break;
            case 203:
                $responseText= "Over limit.";
                break;
            case 204:
                $responseText= "Unfortunately your transaction was declined by your card issuer. You may need to call the card issuer to authorise your tranaction or try a different card.";
                break;
            case 220:
                $responseText= "Incorrect payment information.";
                break;
            case 221:
                $responseText= "No such card issuer.";
                break;
            case 222:
                $responseText= "No card number on file with issuer.";
                break;
            case 223:
                $responseText= "Expired card.";
                break;
            case 224:
                $responseText= "Invalid expiration date.";
                break;
            case 225:
                $responseText= "Invalid card security code.";
                break;
            case 226:
                $responseText= "Invalid PIN.";
                break;
            case 240:
                $responseText= "Unfortunately your transaction was declined by your card issuer. You may need to call the card issuer for further information or try a different card.";
                break;
            case 250:
                $responseText= "Pick up card.";
                break;
            case 251:
                $responseText= "Lost card.";
                break;
            case 252:
                $responseText= "Unfortunately your transaction was declined by your card issuer. You may need to call the card issuer to authorise your tranaction or try a different card.";
                break;
            ...
            case 300:
                ...
                break;
            case 400:
                $responseText= "Transaction error returned by processor.";
                break;
            case 410:
                $responseText= "Invalid merchant configuration.";
                break;
            case 411:
                $responseText= "Merchant account is inactive.";
                break;
            case 420:
                $responseText= "Communication error.";
                break;
            case 421:
                $responseText= "Communication error with issuer.";
                break;
            case 430:
                $responseText= "Duplicate transaction at processor.";
                break;
            case 440:
                $responseText= "Processor format error.";
                break;
            case 441:
                $responseText= "Invalid transaction information.";
                break;
            case 461:
