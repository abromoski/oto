...
define(
	...
	function (Component, url) {
		...
		return Component.extend({
			defaults: {
				template: 'Paytriot_PaymentGateway/payment/form'
			},
			...
			afterPlaceOrder: function () {
				...
				var uri = url.build('paytriot/order/process');
				if (document.cookie.indexOf('Paytriot_PaymentGateway_IntegrationMethod=iframe') > -1 ) {
